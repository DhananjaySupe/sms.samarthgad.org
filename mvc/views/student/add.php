            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="aadhar_no" name="aadhar_no" value="<?=set_value('aadhar_no')?>" >
                        </div>
                         <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="saral_id_no" name="saral_id_no" value="<?=set_value('saral_id_no')?>" >
                        </div>
                         <span class="col-sm-4 control-label">
