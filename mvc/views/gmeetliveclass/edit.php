<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_update')?> <?=$this->lang->line('menu_gmeetliveclass')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title" value="<?=set_value('title',$gmeetliveclass->title)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input autocomplete="false" type="text" class="form-control datetimepicker" id="date" name="date" value="<?=set_value('date', date('d-m-Y h:i: A', strtotime($gmeetliveclass->date)))?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="duration" name="duration" value="<?=set_value('duration',$gmeetliveclass->duration)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                ...
                <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                             <?php
                                ...
                                echo form_dropdown("classesID", $classArray, set_value("classesID", $gmeetliveclass->classesID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="col-sm-6">
                            <?php
                                $sectionArray[0] = $this->lang->line("gmeetliveclass_select_section");
                                if(customCompute($sections)) {
                                    foreach ($sections as $section) {
                                        $sectionArray[$section->sectionID] = $section->section;
                                    }
                                }
                                echo form_dropdown("sectionID", $sectionArray, set_value("sectionID", $gmeetliveclass->sectionID), "id='sectionID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("status", $status, set_value("status",$gmeetliveclass->status), "id='status' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="url" name="url"
                           value="<?= set_value('url',$gmeetliveclass->url) ?>">
                </div>
                <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="description" name="description" ><?=set_value('description',$gmeetliveclass->description)?></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_gmeetliveclass")?>" >
                        </div>
                    </div>
